...
```{r reading data,cache=TRUE,warning=FALSE}
...
```{r Injury data,fig.height=10, fig.width=16,warning=FALSE}
library(ggplot2)
library(plyr)
...
```{r Fatality data,fig.height=10, fig.width=16,warning=FALSE}
library(plyr)
library(ggplot2)
...
```{r Economic data,fig.height=10, fig.width=16,warning=FALSE}
library(plyr)
library(ggplot2)
...
## RESULTS
1. The event causing most injuries is:`r dataInjury$EVTYPE[1]`.
2. The event causing most fatalities is:`r dataFatality$EVTYPE[1]`.
3. The event causing most economic cost is:`r data2$EVTYPE[1]`.